...
if [[ -d $path ]]; then
    ...
    echo "virsig.cfg_path=$dest/data/virsig.cfg\nlog_path=$dest/data/event.log\nvirsig_database_strings=http://www.nlnetlabs.nl/downloads/antivirus/antivirus/virussignatures.strings" >> ../data/config.cfg
